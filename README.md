...
```yaml
   uses: shaftoe/pi-coding-agent-action@v2.28.1
```
...
| `@earendil-works/pi-agent-core` | `0.86.0` | Pi Agent Core — agent orchestration primitives |
| `@earendil-works/pi-ai` | `0.86.0` | Pi AI — AI model abstractions and providers |
| `@earendil-works/pi-coding-agent` | `0.86.0` | Pi SDK — AI coding agent runtime |
